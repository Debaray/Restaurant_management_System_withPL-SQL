...
BEGIN 
 ...
 OPEN employee_cur; 
   LOOP 
	  ...
	  insert into employee1 at site1 VALUES(employee_rec.EID,employee_rec.EName,employee_rec.Address,employee_rec.Phone,employee_rec.Position,employee_rec.Salary);
   END LOOP; 
   CLOSE employee_cur;
   ...
   LOOP 
	  ...
	  insert into catagories1 at site1 VALUES(categories_rec.CID,categories_rec.CName);
   END LOOP; 
   ...
   LOOP 
	  ...
	  insert into menuitems1 at site1 VALUES(menuitems_rec.ItemID,menuitems_rec.ItemName,menuitems_rec.Price,menuitems_rec.CID);
   END LOOP; 
   CLOSE menuitems_cur;
   ...
   LOOP 
	  ...
	  insert into customer1 at site1 VALUES(customer_rec.CustomerID,customer_rec.CustomerName,customer_rec.Address);
   END LOOP; 
   CLOSE customer_cur;
   ...
   LOOP 
	  ...
	  insert into reservation1 at site1 VALUES(reservation_rec.RID,reservation_rec.duration,reservation_rec.RDate,reservation_rec.RTime,reservation_rec.CustomerID);
   END LOOP; 
   ...
   LOOP 
	  ...
	  insert into diningTables1 at site1 VALUES(diningTables_rec.DID,diningTables_rec.WID,diningTables_rec.ChairCount);
   END LOOP; 
   ...
   LOOP 
	  ...
	  insert into orders1 at site1 VALUES(orders_rec.OID,orders_rec.ODate,orders_rec.Quantity,orders_rec.CustomerID,orders_rec.ItemID);
   END LOOP; 
   CLOSE orders_cur;
   ...
   LOOP 
	  ...
	  insert into diningTableTrack1 at site1 VALUES(diningTableTrack_rec.Serial,diningTableTrack_rec.Status,diningTableTrack_rec.OID,diningTableTrack_rec.DID,diningTableTrack_rec.TableServesDate,diningTableTrack_rec.TableServesTime);
   END LOOP; 
   ...
   LOOP 
	  ...
	  insert into reserves1 at site1 VALUES(reserves_rec.RID,reserves_rec.DID);
   END LOOP; 
   CLOSE reserves_cur;
   ...
   LOOP 
	  ...
	  insert into customer1 at site1 VALUES(bills_rec.BID,bills_rec.OID,bills_rec.CustomerID,bills_rec.Discount,bills_rec.Amount,bills_rec.BDate,bills_rec.BTime);
   END LOOP; 
   CLOSE bills_cur;
END; 
commit;
